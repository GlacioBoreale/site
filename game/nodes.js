...
const NODE_DEFS = [
  ...
  },
  {
    ...
    desc: () => [
      { text: 'Unlock more', color: null },
      { text: 'research upgrades', color: '#38bdf8' },
      { text: _nd.perm(), color: '#f87171' },
    ],
    maxLevel: 1,
    baseCost: 10000,
  ...
  },
  {
    ...
    title: 'Deflation',
    desc: [
      { text: 'Point upgrade cost', color: null },
      { text: 'reduced by 5%', color: '#4ade80' },
      { text: 'compounding per level', color: null },
    ],
    maxLevel: 10,
    costFn: (lvl) => 50000 * Math.pow(1.5, lvl),
    baseCost: 0,
    costScale: 1,
    costInPrestige: true,
    zone: 'prestige',
    statLabel: (lvl) => lvl > 0 ? `-${(100 * (1 - Math.pow(0.95, lvl))).toFixed(1)}% \u20bd cost` : '-5% per lvl',
    parents: ['unlazyScientists'],
    onBuy: () => { G.pointCostMult *= 0.95; },
  },
  {
    id: 'ultraRocketShot',
    x: 1620, y: 900,
